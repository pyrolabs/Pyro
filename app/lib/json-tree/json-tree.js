                                ...
                                getType: function(val) {
                                  if (val === null) return 'null'
                                          ...
                                          link: function(scope, element, attrs) {
                                            ...
                                            '<div class="remove" ng-dblclick="utils.removeNode(key)" ng-show="node.isHighEditLevel"><i class="fa fa-minus-circle"></i></div>' +
                                            '<span class="comma" ng-hide="utils.wrap.isLastIndex(node, $index + 1)">,</span>' +
                                            '</div>' +
                                            '</li>' +
                                            '</ul>' +
                                            '<span ng-bind="utils.wrap.end(node)"></span>' +
                                            '<div class="add" ng-show="node.isHighEditLevel && node.isObject()" ng-click="addTpl = !addTpl; inputKey = null; inputValue = null"><i class="fa fa-plus-circle"></i></div>' +
