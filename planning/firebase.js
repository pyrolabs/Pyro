...
(function() {
    ...
    M.prototype.zb = function(a, b, c, d) {
        ...
        if ("value" === a) zc(this.g, this, new Gb(b, e.cancel || null, e.Ha || null));
        else {
            var f = {};
            f[a] = b;
    ...
    M.prototype.fg = function(a, b) {
        ...
        Vb("Query.once", a, !1);
        F("Query.once", 2, b, !1);
        var d = yc("Query.once", arguments[2], arguments[3]),
            e = this,
            f = !0;
    ...
    function yc(a, b, c) {
        ...
        if (b && c) d.cancel = b, F(a, 3, d.cancel, !0), d.Ha = c, Lb(a, 4, d.Ha);
        else if (b)
    ...
    P.prototype.k = function(a) {
        ...
        if (a instanceof P)
            for (c = a.ba; c < a.m.length; c++) b.push(a.m[c]);
        else
    ...
    P.prototype.ea = function(a) {
        ...
        for (var b = this.ba, c = a.ba; b <= this.m.length; b++, c++)
    ...
    h.remove = function(a, b) {
        var c, d;
        c = this;
        if (0 > b(a, c.key)) c.left.e() || c.left.aa() || c.left.left.aa() || (c = Rc(c)), c = c.W(null, null, null, c.left.remove(a, b), null);
        else {
            c.left.aa() && (c = Sc(c));
    ...
    h.hash = function() {
        if (null === this.wb) {
            ...
            var b = typeof this.A,
                a = a + (b + ":"),
                a = "number" === b ? a + Bb(this.A) : a + this.A;
            this.wb = jb(a)
        }
        return this.wb
    };
    ...
    Md.prototype.open = function(a, b) {
        ...
        this.na.onmessage = function(a) {
            if (null !== e.na)
                if (a = a.data, e.kb +=
                    a.length, Ed(e.Pa, "bytes_received", a.length), Od(e), null !== e.frames) Pd(e, a);
                else {
                    a: {
            ...
            if (!c.ub) {
                c.Ma = new Yd(function(a, b, d, k, l) {
                    ...
                    if (c.Ma)
                        ...
                        else if ("close" === a) b ? (c.Ma.Jd = !1, Rd(c.gf, b, function() {
                        c.eb()
                    })) : c.eb();
        ...
        if (a.Zd && a.Jd && a.Fe.count() < (0 < a.Qc.length ? 2 : 1)) {
            ...
            for (var b = a.bd(b), c = "", d = 0; 0 < a.Qc.length;)
                if (1870 >= a.Qc[0].We.length + 30 + c.length) {
                    var e = a.Qc.shift(),
                        c = c + "&seg" + d + "=" + e.ng + "&ts" + d + "=" + e.vg + "&d" + d + "=" + e.We;
                    d++
                } else break;
            be(a, b + c, a.ke);
            return !0
    ...
    function ie(a, b) {
        return function(c) {
            if (2 != a.Oa)
                ...
                if (d = xb("t", c), c = xb("d", c), "c" == d) "t" in c && (c = c.t, "a" === c ? qe(a) : "r" === c ? (a.f("Got a reset on secondary, closing it"), a.C.close(), a.ad !== a.C && a.Xc !== a.C || a.close()) : "o" === c && (a.f("got pong on secondary."),
                    a.tf--, qe(a)));
    ...
    function qe(a) {
        ...
        }), a.ad = a.C, me(a)) : (a.f("sending ping on secondary."), a.C.send({
            t: "c",
            d: {
                t: "p",
                d: {}
    ...
    function pe(a) {
        a.vb || 1 !== a.Oa || (a.f("sending ping on primary."), re(a, {
            t: "c",
            d: {
                t: "p",
                d: {}
    ...
    function ve(a, b, c, d) {
        ...
        xe(this, 0);
        td.Qb().zb("visible", this.eg, this); - 1 === a.host.indexOf("fblocal") && ud.Qb().zb("online", this.cg, this)
    }
    var we = 0,
        ye = 0;
    h = ve.prototype;
    ...
    h.Ce = function(a, b) {
        this.da ? Ee(this, "oc", a, null, b) : this.Jc.push({
            Pc: a,
            action: "oc",
            data: null,
            H: b
    ...
    h.jf = function() {
        ...
        if (this.Eb) this.qc ? this.Dc && (3E4 < (new Date).getTime() - this.Dc && (this.Va = 1E3), this.Dc = null) : (this.f("Window isn't visible.  Delaying reconnect."), this.Va = this.xd, this.ue = (new Date).getTime()), a = Math.max(0, this.Va - ((new Date).getTime() - this.ue)), a *= Math.random(), this.f("Trying to reconnect in " +
            a + "ms"), xe(this, a), this.Va = Math.min(this.xd, 1.3 * this.Va);
        else
    ...
    pf.prototype.get = function() {
        var a = La(this.Pd, q(this.Sf, this)),
            a = Ka(a, function(a) {
                return null !== a
            });
        Ta(a, function(a, c) {
    ...
    function tf(a) {
        ...
        if (b) {
            ...
            var d = [kf, nf],
                b = {
                    requestId: b,
                    requestKey: ef(document.location.hash)
                },
                c = new Xe(c, {}, b);
            try {
        ...
        if (b.type === Qf) {
            if (b.sf) a: {
                ...
                if (a.D) {
                    ...
                    if (a.o)(d = c.Ob()) ? b = this.F(d) : (c = c.Ya(f, a.o, a.n)) && (b = this.F(b.L(f, c)));
                    else {
    ...
    h.Ea = function(a, b, c, d) {
        ...
        if (a.D) {
            ...
            if (k)
                if (b.e()) e = this.F(k);
                else return g = G(b), b = e.L(b, k).B(g), this.Qa(a, g, b, a.D, a.n, c, d)
        } else if (a.n)
            if (e) {
                var l = !1;
    ...
    h.Ra = function(a, b, c, d, e, f) {
        ...
        var k = a.D,
            l = a.n;
        if (a.D) k = b.e() ? this.F(c, f) : this.F(a.D.L(b, c), f);
        else if (b.e()) k = this.F(c, f), l = null;
        else if (1 === Q(b) && (a.n || !c.e())) l = a.n || this.Ia(K), l = this.F(l.L(b, c), f);
        else if (a.n && (g = G(b), a.n.Y(g))) var m = a.n.B(g).L(R(b), c),
            l = this.F(a.n.I(g, m), f);
        g = !1;
        f = a.o;
        m = a.X;
        if (k !== a.D || l !== a.n)
            if (k && !f) f = this.F(d.xa(k)), m = null;
            else if (k && f && !c.e() && k.$(b).ea(f.$(b))) g = !0;
        else if (c = d.Ya(b, f, k || l))
            if (b.e()) f = this.F(c), m = null;
            else {
                g = G(b);
                b = R(b);
                a: {
    ...
    Xf.prototype.F = function(a, b) {
        ...
        var c = this.Ia(a),
            d, e, f, g;
        if (2 * this.bb < a.Ta())
            for (d = this.Ia(K.ib(a.O())), c = this.La ? c.Sb(this.pb, this.index) : c.rb(this.Fb, this.index), e = U(c), f = 0; e && f < this.bb;)
                if (g = this.La ? 0 >= H(this.index)(this.Fb, e) : 0 >= H(this.index)(e, this.pb)) d = d.I(e.name, e.K), f++, e = U(c);
                else break;
        else {
            d = this.Ia(a);
    ...
    function Yf(a, b, c, d, e, f) {
        ...
        var l = new I(c, d),
            m = a.La ? jd(b, a.index) : kd(b, a.index);
                    ...
                    if (!k && !l)
                        if ("children_added" === g.type) {
                            var s = a,
                                ...
                                l = [];
                            if (!y.P() && !y.e())
                                for (var s = y.Aa(s.w), y = null, N = U(s); N;) {
                        ...
                        if (s = a, y = g.Wa, l = [], !y.P() && !y.e())
                            for (s = y.Aa(s.w), y = U(s); y;) l.push(new W("child_removed", y.K, y.name)), y = U(s)
    ...
    function jg(a, b, c) {
        ...
        var d = G(b);
        a = a.children.get(d);
        return null !== a ? (b = jg(a, R(b), c), null != b ? {
    ...
    h.set = function(a, b) {
        ...
        var c = G(a),
            d = (this.children.get(c) || ig).set(R(a), b),
    ...
    h.hb = function(a, b, c) {
        ...
        if (e && ("default" === a.Da() || null != yg(e, a))) {
            ...
            if (b && !g && (d = this.ma.subtree(d), !d.e()))
                for (var d = Yg(d), k = 0; k < d.length; ++k) {
                    var l = d[k],
                        m = l.U,
                        l = Zg(this, l);
    ...
    function Xg(a, b, c) {
        ...
        d = a.ma.subtree(d);
        if (e) x(null == wg(d.value), "If we're adding a query, it shouldn't be shadowed");
        else
            for (e = mg(d, function(a, b, c) {
        ...
        return {
            ...
            H: function(b, f) {
                if ("ok" === b) {
                    ...
                    if (d) {
                        var k = c.path;
                        if (g = Ad(a.Zc, "_" + d)) var l = Sg(g),
                            g = l.path,
                            l = l.fc,
                            k = T(g, k),
                            k = new Lg(new Ng(!1, !0, l, !0), k),
                            g = Tg(a, g, k);
                        else g = []
    ...
    h.update = function(a, b, c) {
        ...
        if (d) ib("update() called with empty data.  Don't do anything."), jh(c, "ok");
        else {
            var g = this.zd++,
                k = this.M.ae(a, f, g);
            Se(this.Z, k);
    ...
    function uh(a, b, c) {
        if (0 !== b.length) {
            for (var d = [], e = [], f = La(b, function(a) {
                ...
                if (5 === k.status) m = !0, r = k.Yd, e = e.concat(a.M.Ea(k.ra, !0));
                else if (1 === k.status)
                    if (25 <= k.rf) m = !0, r = "maxretry", e = e.concat(a.M.Ea(k.ra, !0));
                    else {
    ...
    function wh(a, b) {
        var c = b.ta();
        if (null !== c) {
            for (var d = [], e = [], f = -1, g = 0; g < c.length; g++) 4 !== c[g].status && (2 === c[g].status ? (x(f === g - 1, "All SENT items should be at beginning of queue."), f = g, c[g].status = 4, c[g].Yd = "set") : (x(1 === c[g].status, "Unexpected transaction status in abort"), c[g].Vd(), e = e.concat(a.M.Ea(c[g].ra, !0)), c[g].H && d.push(q(c[g].H, null, Error("set"), !1, null)))); - 1 === f ? Fc(b, null) : c.length = f + 1;
            Ve(a.Z, b.path(), e);
            for (g = 0; g < d.length; g++) Db(d[g])
        }
    };
    ...
    function O(a, b) {
        ...
        if (a instanceof dh) c = a, d = b;
            ...
            if (b)
                if (b instanceof xh) e = b;
                else if (p(b)) e = xh.Qb(), c.Gd = b;
    ...
    O.prototype.Gf = function(a, b, c, d) {
        ...
        p(b) ? ($b("Firebase.authWithOAuthToken", 2, b), zf(this.g.T, a + "/token", {
            access_token: b
        }, d, c)) : (ac("Firebase.authWithOAuthToken", 2, b, !1), zf(this.g.T, a + "/token", b, d, c))
    };
